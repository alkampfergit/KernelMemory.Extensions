...
Write-Host "\n\n*******************RESTORING PACKAGES*******************"
dotnet restore "$runningDirectory/src/KernelMemory.Extensions.sln"
Assert-LastExecution -message "Error in restoring packages." -haltExecution $true

Write-Host "\n\n*******************TESTING SOLUTION*******************"
dotnet test "src/KernelMemory.Extensions.FunctionalTests/KernelMemory.Extensions.FunctionalTests.csproj" `
...
Write-Host "\n\n*******************BUILDING SOLUTION*******************"
dotnet build "$runningDirectory/src/KernelMemory.Extensions.sln" --configuration release
